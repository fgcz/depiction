...
Today the file already earns its keep three ways:
...
#: below into an A/B parity check; that is the whole point of the file.
...
class TestCompression:
    ...
    def test_checksum_is_still_valid(self, read_file: GenericReadFile) -> None:
        ...
        assert read_file.is_checksum_valid is not False
