...
class TestIsotopePatternMatcher(unittest.TestCase):
    ...
    def test_get_averagine_pattern_when_cache_empty(self):
    ...
    @unittest.skip
    def test_get_averagine_pattern_when_cache_not_empty_but_miss(self):
        raise NotImplementedError

    @patch.object(IsotopePatternMatcher, "_compute_averagine_pattern")
    def test_get_averagine_pattern_when_cache_hit_exact(self, method_compute_averagine_pattern):
    ...
    @patch.object(IsotopePatternMatcher, "_compute_averagine_pattern")
    def test_get_averagine_pattern_when_cache_hit_tolerance(self, method_compute_averagine_pattern):
    ...
    @unittest.skip
    def test_get_averagine_pattern_when_cache_evict(self):
        raise NotImplementedError

    def test_compute_spectra_agreement_when_mz_identical(self):
    ...
    def test_compute_spectra_agreement_when_mz_identical_start(self):
        spectrum_1 = (
