...
class TestReferenceDistanceEstimator(unittest.TestCase):
    ...
    def test_compute_distances_for_peaks(self):
    ...
    def test_compute_distances_for_peaks_when_left_out_of_bounds(self):
    ...
    def test_compute_distances_for_peaks_when_right_out_of_bounds(self):
