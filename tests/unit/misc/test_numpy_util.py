...
class TestNumpyUtil(unittest.TestCase):
    ...
    def test_search_sorted_closest_when_internal_values(self) -> None:
    ...
    def test_search_sorted_closest_when_left_boundary(self) -> None:
    ...
    def test_search_sorted_closest_when_left_out_of_boundary(self) -> None:
        closest_indices = NumpyUtil.search_sorted_closest(self.mock_full_array, np.array([-2, 9]))
        np.testing.assert_array_equal([0, 0], closest_indices)

    def test_search_sorted_closest_when_right_boundary(self) -> None:
    ...
    def test_get_first_index_when_boolean(self) -> None:
