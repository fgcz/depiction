...
class TestResampleMassAxis(unittest.TestCase):
    ...
    def test_evaluate_spectrum_when_exact(self):
    ...
    def test_evaluate_spectrum_when_interpolated(self):
    ...
    def test_evaluate_spectrum_when_extrapolating_expect_zeros(self):
