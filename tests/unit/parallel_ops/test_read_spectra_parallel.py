...
from ionmapper.persistence import RamReadFile
...
class TestReadSpectraParallel(unittest.TestCase):
    ...
    def test_map_chunked_default(self):
    ...
    def test_map_chunked_when_pass_task_index(self):
    ...
    def test_map_chunked_when_spectra_indices(self):
    ...
    def test_map_chunked_when_bind_args(self):
    ...
    def test_map_chunked_when_reduce_concat(self):
        def operation(reader, indices):
