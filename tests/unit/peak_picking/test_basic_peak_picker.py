...
class TestBasicPeakPicker(unittest.TestCase):
    ...
    def test_get_smoothed_intensities(self, mock_gaussian_filter1d):
    ...
    def test_get_smoothed_intensities_when_sigma_is_none(self):
    ...
    def test_pick_peaks_index(self):
    ...
    def test_pick_peaks_index_when_min_distance(self):
    ...
    def test_pick_peaks_mz(self, method_pick_peaks_index):
    ...
    def test_get_min_distance_indices_when_none(self):
        mock_mz_arr = MagicMock(name="mock_mz_arr", spec=[])
        self.assertIsNone(
            BasicPeakPicker.get_min_distance_indices(min_distance=None, min_distance_unit=None, mz_arr=mock_mz_arr)
        )

    def test_get_min_distance_indices_when_unit_index(self):
        mock_min_distance = 3
    ...
    def test_get_min_distance_indices_when_unit_mz(self):
