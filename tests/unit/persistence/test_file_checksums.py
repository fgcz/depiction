...
class TestFileChecksums(unittest.TestCase):
    ...
    def test_checksum_md5(self, method_compute_checksum):
    ...
    @patch.object(FileChecksums, "_compute_checksum")
    def test_checksum_sha1(self, method_compute_checksum):
    ...
    @patch.object(FileChecksums, "_compute_checksum")
    def test_checksum_sha256(self, method_compute_checksum):
    ...
    def test_checksum_when_native_tool_available(self, mock_subprocess_run, mock_shutil_which):
    ...
    @patch("builtins.open")
    @patch("shutil.which")
    def test_checksum_when_native_tool_not_available(self, mock_shutil_which, mock_open):
